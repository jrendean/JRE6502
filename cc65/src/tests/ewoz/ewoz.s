...
NEXTCHAR:   LDA ACIA1_STATUS     ;*See if we got an incoming char
            AND #$08        ;*Test bit 3
            BEQ NEXTCHAR    ;*Wait for character
            LDA ACIA1_DATA    ;*Load char
...
ECHO:       PHA             ;*Save A
            ...
            STA ACIA1_DATA    ;*Send it.
WAIT:       LDA ACIA1_STATUS     ;*Load status register for ACIA
            AND #$10        ;*Mask bit 4.
...
GETCHAR:    LDA ACIA1_STATUS     ; See if we got an incoming char
            AND #$08        ; Test bit 3
